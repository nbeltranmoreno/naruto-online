...
export const JUTSUS = [
  {
    ...
    damage: (lvl) => 10 + lvl * 2, speed: 490, radius: 8, pierce: 1, life: 1.1, color: '#cbd5e1'
  },
  {
    id: 'katon', slot: 2, name: 'Bola de Fuego', level: 3, cost: 18,
    damage: (lvl) => 22 + lvl * 3, speed: 340, radius: 18, pierce: 3, life: 1.0, color: '#fb923c'
  },
  {
    id: 'rasengan', slot: 3, name: 'Rasengan', level: 6, cost: 32,
    damage: (lvl) => 45 + lvl * 5, speed: 280, radius: 24, pierce: 99, life: 0.75, color: '#67e8f9'
  }
];
...
export const ENEMY_TYPES = {
  bandido: { kind: 'ninja', outfit: 'bandido', hp: 30, damage: 6, speed: 95, xp: 12, aggro: 265, scale: 1, name: 'Bandido' },
  lobo:    { kind: 'wolf',  outfit: null,      hp: 24, damage: 5, speed: 145, xp: 10, aggro: 340, scale: 1, name: 'Lobo' },
  ronin:   { kind: 'ninja', outfit: 'ronin',   hp: 58, damage: 11, speed: 110, xp: 26, aggro: 300, scale: 1.05, name: 'Ronin' },
  jefe:    { kind: 'ninja', outfit: 'jefe',    hp: 240, damage: 20, speed: 98, xp: 160, aggro: 400, scale: 1.4, name: 'Ninja Desertor' }
};
